...
<!-- wp:cover {"url":"<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/header-image.jpg","id":1876,"dimRatio":0,"focalPoint":{"x":0.5,"y":0.5},"minHeight":90,"minHeightUnit":"vh","isDark":false,"align":"full","className":"hero-image"} -->
